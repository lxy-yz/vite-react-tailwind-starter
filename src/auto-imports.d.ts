...
declare global {
  ...
  const IconIcOutlineDarkMode: typeof import('~icons/ic/outline-dark-mode.jsx')['default']
  const IconIcOutlineLightMode: typeof import('~icons/ic/outline-light-mode.jsx')['default']
